...
export const metadata: Metadata = buildMetadata({
  title: 'Terms of Use',
  description:
    'The terms and conditions for using SeniorSafeHome, including the limits of our safety information and your responsibilities as a reader.',
  path: '/terms',
});
    ...
    <>
      ...
      <Container className="py-12">
        <div className="prose-ssh max-w-3xl">
          <p>
            Welcome to SeniorSafeHome. By accessing or using this website, you agree to these Terms
            of Use. If you do not agree, please do not use the site.
          </p>

          <h2>Informational purpose only</h2>
          <p>
            The content on SeniorSafeHome is provided for general informational purposes. It is not
          ...
          <p>
            To the fullest extent permitted by law, SeniorSafeHome and its contributors are not
          ...
          <p>
            The content on this site, including text and design, is owned by SeniorSafeHome unless
